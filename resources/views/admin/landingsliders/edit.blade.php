    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md">
            <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700">
                <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Edit Slide</h3>
            </div>
            <div class="p-6">
                <form action="{{ route('admin.landingsliders.update', $landingslider) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="mb-6">
                        ...
                        <input type="text" name="title" id="title"
                            ...
                            value="{{ old('title', $landingslider->title) }}" required>
                        @error('title')
                    ...
                    <div class="mb-6">
                        ...
                        <div class="mb-4">
                            <img src="{{ Storage::url('slides/' . $landingslider->image) }}" alt="{{ $landingslider->title }}"
