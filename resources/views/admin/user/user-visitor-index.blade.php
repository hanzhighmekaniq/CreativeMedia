<x-LayoutAdmin>
    <div class="bg-[#0f172a]  ">
        <div class="w-full mx-auto ">
            <p class="text-2xl font-bold text-white pb-2">Visitor</p>

            <!-- Filters Section -->
            <div class="bg-[#1e293b] rounded-xl mb-4">
                <div class="p-6">
                    <form method="GET" action="{{ route('admin.visitors.index') }}" class="space-y-4">
                                ...
                                <tr class="hover:bg-[#334155] duration-200">
                                        ...
                                        <div class="flex items-center">
                                            <div class="flex-shrink-0 h-12 w-12">
                                                <img class="h-12 w-12 rounded-full object-cover"
                                                    src="{{ asset($user->img) }}" alt="{{ $user->name }}">
                                            </div>
                                            <div class="ml-4">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-left text-sm font-medium">
                                        <div class="flex items-center justify-start space-x-2">
                                            <!-- Edit User -->
                                            <a href="{{ route('admin.visitors.edit', $user->id) }}"
                                            ...
                                            <!-- Delete User -->
                                            <button onclick="openDeleteModal('{{ route('admin.visitors.destroy', $user->id) }}')"
    ...
    <div id="deleteModal" class="fixed inset-0 bg-gray-600 bg-opacity-50 hidden items-center justify-center z-50">
        <div class="bg-[#1e293b] rounded-lg p-6 max-w-sm mx-4 w-full">
            <div class="flex items-center mb-4">
                ...
                <div class="ml-3">
                    <h3 class="text-lg font-medium text-white">Delete Visitor</h3>
                </div>
            </div>
            <p class="text-sm text-gray-400 mb-4">Are you sure you want to delete this visitor? This action cannot be undone.</p>
